                    ...
                    <div className="space-y-12">
                        ...
                        <header className={`space-y-8 transition-all duration-1000 delay-100 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                                ...
                                <div className={`group ${theme.surfaceHigh} ${theme.border} ${theme.borderHover} border rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1`}>
                                    <div className="space-y-2">
                                        <span className={`text-xs font-medium tracking-wider uppercase ${theme.text.subtle}`}>Co-Guide</span>
                            ...
                            <section className={`group ${theme.surfaceHigh} ${theme.border} ${theme.borderHover} border rounded-3xl p-8 shadow-lg hover:shadow-xl transition-all duration-500`}>
                                <div className="space-y-6">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <h2 className={`text-2xl font-bold tracking-tight ${theme.text.headline}`}>Team Lead Email</h2>
                                    </div>
                        ...
                        {/* Remarks Section */}
                        <section className={`transition-all duration-1000 delay-500 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                            <div className={`group ${theme.surfaceHigh} ${theme.border} ${theme.borderHover} border rounded-3xl p-8 shadow-lg hover:shadow-xl transition-all duration-500`}>
                                <div className="space-y-6">
                                    <div className="flex items-center gap-4">
                                    ...
                                    {role === "ADMIN" && (
                                        <div className="flex gap-3 pt-6 border-t border-slate-700">
                                            <input
                                                type="text"
                                                className={`flex-1 rounded-xl ${theme.input} border px-4 py-3 text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 transition-all duration-200`}
                                            ...
                                            <button
                                                ...
                                                className="px-6 py-3 rounded-xl bg-gradient-to-r from-emerald-600 to-blue-600 text-white text-sm font-semibold hover:scale-105 active:scale-95 focus:ring-2 focus:ring-emerald-500 transition-all duration-200 shadow-lg"
                                            >
                                                Add Remark
                                            </button>
                                        </div>
                        ...
                        {/* Action Buttons */}
                        <div className={`sticky bottom-8 transition-all duration-1000 delay-600 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                            <div className={`${theme.glass} ${theme.border} border rounded-2xl p-6 shadow-2xl`}>
                                <div className="flex flex-col sm:flex-row gap-4">
                                    ...
                                    >
                                        ...
                                        <span className="font-semibold">View PDF Summary</span>
                                    </button>
