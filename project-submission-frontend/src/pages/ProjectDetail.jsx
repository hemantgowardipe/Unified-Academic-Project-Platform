...
const ProjectDetail = () => {
    ...
    if (!project)
        return (
            <div className={`pd-bg ${theme.bg} transition-colors duration-300`}>
    ...
    return (
        <div className={`pd-bg ${theme.bg} transition-colors duration-300`}>
            ...
            <button
                onClick={toggleTheme}
                className={`fixed top-4 right-4 z-50 p-3 rounded-full ${theme.button} ${theme.buttonBorder} border transition-all duration-300 hover:scale-110`}
                ...
                <div className="pd-container">
                    ...
                    <header className="pd-header">
                        <div className="pd-title-section">
                            <h1 className={`pd-title ${theme.text.primary} transition-colors duration-300`}>
                                {project.title}
                            </h1>
                        ...
                        <div className="pd-metadata">
                            <div className={`pd-meta-card ${theme.cardBg} ${theme.border} border transition-colors duration-300`}>
                                <span className={`pd-meta-label ${theme.text.muted}`}>Project Guide</span>
                                <span className={`pd-meta-value ${theme.text.primary}`}>{project.guideName}</span>
                            </div>
                            <div className={`pd-meta-card ${theme.cardBg} ${theme.border} border transition-colors duration-300`}>
                                <span className={`pd-meta-label ${theme.text.muted}`}>Project Co-Guide</span>
                                <span className={`pd-meta-value ${theme.text.primary}`}>{project.coGuideName}</span>
                            </div>

                            <div className="pd-meta-grid">
                                <div className={`pd-meta-card ${theme.cardBg} ${theme.border} border transition-colors duration-300`}>
                                    <span className={`pd-meta-label ${theme.text.muted}`}>Start Date</span>
                                    <span className={`pd-meta-value ${theme.text.primary}`}>{project.startDate}</span>
                                </div>
                                <div className={`pd-meta-card ${theme.cardBg} ${theme.border} border transition-colors duration-300`}>
                                    <span className={`pd-meta-label ${theme.text.muted}`}>Final Submission</span>
                    ...
                    {/* DESCRIPTION */}
                    <section className={`pd-description-section ${theme.cardBg} ${theme.border} border transition-colors duration-300`}>
                    ...
                    <div className="pd-main-grid">
                        <section className={`pd-section ${theme.cardBg} ${theme.border} border transition-colors duration-300`}>
                            <div className="pd-section-header">
                    ...
                    {/* REPO */}
                    <section className={`pd-section pd-repo-section ${theme.cardBg} ${theme.border} border transition-colors duration-300`}>
                        <div className="pd-section-header">
                        ...
                        <div className="pd-repo-content">
                            <a
                                className={`pd-repo-link ${theme.accent} text-white hover:opacity-90 transition-all duration-300`}
                    ...
                    <div className="pd-actions">
                        ...
                        >
                            <button className={`pd-btn ${theme.button} ${theme.buttonBorder} border transition-all duration-300`}>
                                <span className={`pd-btn-text ${theme.text.primary}`}>View Git Timeline</span>
                                <div className="pd-btn-glow"></div>
                            </button>
                        </a>

                        <button className={`pd-btn ${theme.button} ${theme.buttonBorder} border transition-all duration-300`} onClick={handleViewPDF}>
                            <span className={`pd-btn-text ${theme.text.primary}`}>View Project Summary PDF</span>
                            <div className="pd-btn-glow"></div>
                        </button>
                        ...
                        {role === 'STUDENT' && (
                            <button
                                className={`pd-btn ${theme.accent} ${theme.accentHover} text-white transition-all duration-300`}
                    ...
                    <section className={`pd-section ${theme.cardBg} ${theme.border} border transition-colors duration-300`}>
                                    ...
                                    <div key={idx} className="pd-list-item">
                                        ...
                                        <div>
                                            <p className={theme.text.secondary}>
                                                <strong className={theme.text.primary}>{remark.author}:</strong> {remark.text}
                                            </p>
                        ...
                        {role === "ADMIN" && (
                            <div className="mt-4 flex gap-2">
                                <input
                                    type="text"
                                    className={`flex-1 rounded-lg ${theme.searchBg} ${theme.searchBorder} border px-4 py-2 text-sm ${theme.text.primary} placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-300`}
                                ...
                                <button
                                    ...
                                    className={`px-5 py-2 rounded-lg ${theme.accent} ${theme.accentHover} text-white text-sm font-medium focus:ring-2 focus:ring-offset-1 focus:ring-blue-500 transition-all duration-300`}
                                >
                                    Add Remark
                                </button>
                            </div>
