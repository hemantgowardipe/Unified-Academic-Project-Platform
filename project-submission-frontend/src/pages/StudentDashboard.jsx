        ...
        >
            ...
            <div className="relative z-10">
                ...
                <div className="space-y-3 sm:space-y-4">
                    <h3 className="text-lg sm:text-xl font-bold font-mono text-gray-900 group-hover:text-indigo-900 transition-colors duration-300 line-clamp-2">
                        {project.title}
                    </h3>
                    
                    <p className="text-sm sm:text-base font-sans text-gray-600 line-clamp-3 leading-relaxed">
                        {project.description}
                    </p>
